...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\YusrGP\YusrProject\assets\frame30")
...
def open_GamePage6():
    file_to_run_path = r"C:\YusrGP\YusrProject\GamePage6.py"
    window.destroy()
...
def perform_action(event):
    sound = pygame.mixer.Sound(r"C:\YusrGP\YusrProject\assets\frame30\Game5.mp3")
    sound.play()
