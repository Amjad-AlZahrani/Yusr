...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\YusrGP\YusrProject\assets\frame10")
...
def perform_action(event):
    sound = pygame.mixer.Sound(r"C:\YusrGP\YusrProject\assets\frame10\SayLetter.mp3")
    sound.play()
...
#----------button Recording the letter Qa----------
...
variable=radio_var1,
value=2,
command=lambda: record_and_save_audio("recorded_audio2.wav"))
...
#----------button Recording the letter Qe----------
...
variable=radio_var2,
value=4,
command=lambda: record_and_save_audio("recorded_audio3.wav"))
...
#------------button Recording the letter Qo----------
...
variable=radio_var3,
value=6,
command=lambda: record_and_save_audio("recorded_audio4.wav"))
...
def open_KafPage():
    if radio_var1.get() != 0 and radio_var2.get() != 0 and radio_var3.get() != 0:
        ...
        if radio_var1.get()  == 1:
            ...
            AudioRecord(r"C:\YusrGP\YusrProject\recorded_audio2.wav",id1="ga",id2="ga")
        if radio_var2.get()  == 3:
            score += 2
        elif radio_var2.get()  == 4: 
            AudioRecord(r"C:\YusrGP\YusrProject\recorded_audio3.wav",id1="gi",id2="gi")
        if radio_var3.get()  == 5:
            score += 2
        elif radio_var3.get()  == 6: 
            AudioRecord(r"C:\YusrGP\YusrProject\recorded_audio4.wav",id1="go",id2="go")
        addScore3(score)
        file_to_run_path = r"C:\YusrGP\YusrProject\KafPage.py"
        window.destroy()
        subprocess.run(["python", file_to_run_path], check=True)
...
borderwidth=0,
highlightthickness=0,
command=open_KafPage, # Call the function to open page two
relief="flat"
)
button_7.place(
    x=141.0,
